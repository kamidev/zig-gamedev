...
const content_dir = "physically_based_rendering_content/";
...
pub fn build(b: *std.build.Builder, options: Options) *std.build.LibExeObjStep {
    ...
    const exe = b.addExecutable(
        ...
        comptime thisDir() ++ "/src/physically_based_rendering.zig",
    );
...
fn buildShaders(b: *std.build.Builder) *std.build.Step {
    const dxc_step = b.step("physically_based_rendering-dxc", "Build shaders for 'physically based rendering' demo");
